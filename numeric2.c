...
x1[1] = (1/a2[1])*(-a2[0]*x1[0] -a2[2]*x0[2] -a2[3]*x0[3] - 1);
x1[2] = (1/a3[2])*(-a3[0]*x1[0] -a3[1]*x1[1] -a3[3]*x0[3] + 1);
x1[3] = (1/a4[3])*(-a4[0]*x1[0] -a4[1]*x1[1] -a4[2]*x1[2] + 0);
...
x2[1] = (1/a2[1])*(-a2[0]*x2[0] -a2[2]*x1[2] -a2[3]*x1[3] - 1);
x2[2] = (1/a3[2])*(-a3[0]*x2[0] -a3[1]*x2[1] -a3[3]*x1[3] + 1);
x2[3] = (1/a4[3])*(-a4[0]*x2[0] -a4[1]*x2[1] -a4[2]*x2[2] + 0);
